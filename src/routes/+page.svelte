<script lang="ts">
  ...
  onMount(() => {
    getFooterSnippet().snippet = footer;
  });
</script>
...
<div
  class="w-full shrink-0 bg-tertiary/95 bg-[image:var(--bg-image)] bg-cover bg-bottom bg-no-repeat pb-6 pt-2 bg-blend-lighten sm:bg-left sm:py-6 md:bg-contain md:bg-right"
  ...
  >
    <div class="flex w-full flex-col items-center gap-6">
      <div class="w-full max-w-2xl">
        <h2
          class="mb-6 w-full rounded-lg bg-secondary-alt text-center font-serif text-2xl font-bold uppercase"
        >
      ...
      <div class="flex flex-col items-center gap-2">
        <p class="max-w-2xl text-center text-lg">
          Entre na loja e escolha entre mais opções!
        </p>
    ...
    <div id="info" class="flex w-full flex-col items-center gap-6">
      <div class="w-full max-w-2xl">
        <h2
          class="rounded-lg bg-secondary-alt/80 text-center font-serif text-2xl font-bold uppercase"
        >
          Quando
        </h2>
      </div>
    ...
    <div class="flex w-full flex-col items-center gap-6">
      ...
      <div
        class="mx-auto flex w-full max-w-2xl flex-col gap-4 sm:grid sm:grid-cols-2"
      >
        <div class="flex flex-col justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            class="flex w-fit items-center gap-2 self-center rounded-full border border-sky-600 bg-white px-4 py-2 font-serif text-xl transition-colors hover:text-sky-600"
          >
            <svg
              class="size-6"
              aria-hidden="true"
        ...
        <iframe
          ...
          class="aspect-square w-full sm:-order-1"
